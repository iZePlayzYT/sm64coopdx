...
const GeoLayout* DynOS_Builtin_Actor_GetFromIndex(s32 aIndex) {
    if (aIndex < 0 || aIndex >= DynOS_Builtin_Actor_GetCount()) { return NULL; }
...
static const DynosBuiltinFunction sDynosBuiltinFuncs[] = {
    define_builtin_function(geo_mirror_mario_set_alpha, PTYPE_FUNC_GEO),
    define_builtin_function(geo_switch_mario_stand_run, PTYPE_FUNC_GEO),
    define_builtin_function(geo_switch_mario_eyes, PTYPE_FUNC_GEO),
    define_builtin_function(geo_mario_tilt_torso, PTYPE_FUNC_GEO),
    define_builtin_function(geo_mario_head_rotation, PTYPE_FUNC_GEO),
    define_builtin_function(geo_switch_mario_hand, PTYPE_FUNC_GEO),
    define_builtin_function(geo_mario_hand_foot_scaler, PTYPE_FUNC_GEO),
    define_builtin_function(geo_switch_mario_cap_effect, PTYPE_FUNC_GEO),
    define_builtin_function(geo_switch_mario_cap_on_off, PTYPE_FUNC_GEO),
    define_builtin_function(geo_mario_rotate_wing_cap_wings, PTYPE_FUNC_GEO),
    define_builtin_function(geo_switch_mario_hand_grab_pos, PTYPE_FUNC_GEO),
    define_builtin_function(geo_render_mirror_mario, PTYPE_FUNC_GEO),
    define_builtin_function(geo_mirror_mario_backface_culling, PTYPE_FUNC_GEO),
    define_builtin_function(geo_update_projectile_pos_from_parent, PTYPE_FUNC_GEO),
    define_builtin_function(geo_update_layer_transparency, PTYPE_FUNC_GEO),
    define_builtin_function(geo_switch_anim_state, PTYPE_FUNC_GEO),
    define_builtin_function(geo_switch_area, PTYPE_FUNC_GEO),
    define_builtin_function(geo_camera_main, PTYPE_FUNC_GEO),
    define_builtin_function(geo_camera_fov, PTYPE_FUNC_GEO),
    define_builtin_function(geo_envfx_main, PTYPE_FUNC_GEO),
    define_builtin_function(geo_skybox_main, PTYPE_FUNC_GEO),
    define_builtin_function(geo_wdw_set_initial_water_level, PTYPE_FUNC_GEO),
    define_builtin_function(geo_movtex_pause_control, PTYPE_FUNC_GEO),
    define_builtin_function(geo_movtex_draw_water_regions, PTYPE_FUNC_GEO),
    define_builtin_function(geo_movtex_draw_nocolor, PTYPE_FUNC_GEO),
    define_builtin_function(geo_movtex_draw_colored, PTYPE_FUNC_GEO),
    define_builtin_function(geo_movtex_draw_colored_no_update, PTYPE_FUNC_GEO),
    define_builtin_function(geo_movtex_draw_colored_2_no_update, PTYPE_FUNC_GEO),
    define_builtin_function(geo_movtex_update_horizontal, PTYPE_FUNC_GEO),
    define_builtin_function(geo_movtex_draw_colored_no_update, PTYPE_FUNC_GEO),
    define_builtin_function(geo_painting_draw, PTYPE_FUNC_GEO),
    define_builtin_function(geo_painting_update, PTYPE_FUNC_GEO),
    define_builtin_function(geo_exec_inside_castle_light, PTYPE_FUNC_GEO),
    define_builtin_function(geo_exec_flying_carpet_timer_update, PTYPE_FUNC_GEO),
    define_builtin_function(geo_exec_flying_carpet_create, PTYPE_FUNC_GEO),
    define_builtin_function(geo_exec_cake_end_screen, PTYPE_FUNC_GEO),
    define_builtin_function(geo_cannon_circle_base, PTYPE_FUNC_GEO),
    define_builtin_function(geo_move_mario_part_from_parent, PTYPE_FUNC_GEO),
    define_builtin_function(geo_bits_bowser_coloring, PTYPE_FUNC_GEO),
    define_builtin_function(geo_update_body_rot_from_parent, PTYPE_FUNC_GEO),
    define_builtin_function(geo_switch_bowser_eyes, PTYPE_FUNC_GEO),
    define_builtin_function(geo_switch_tuxie_mother_eyes, PTYPE_FUNC_GEO),
    define_builtin_function(geo_update_held_mario_pos, PTYPE_FUNC_GEO),
    define_builtin_function(geo_snufit_move_mask, PTYPE_FUNC_GEO),
    define_builtin_function(geo_snufit_scale_body, PTYPE_FUNC_GEO),
    define_builtin_function(geo_scale_bowser_key, PTYPE_FUNC_GEO),
    define_builtin_function_renamed(geo_rotate_3d_coin, geo_rotate_coin, PTYPE_FUNC_GEO),
    define_builtin_function(geo_offset_klepto_held_object, PTYPE_FUNC_GEO),
    define_builtin_function(geo_switch_peach_eyes, PTYPE_FUNC_GEO),

    // Co-op specific
    define_builtin_function(geo_mario_set_player_colors, PTYPE_FUNC_GEO),
    define_builtin_function(geo_movtex_draw_water_regions_ext, PTYPE_FUNC_GEO),
    define_builtin_function(lvl_init_or_update, PTYPE_FUNC_LVL),
    define_builtin_function(geo_choose_area_ext, PTYPE_FUNC_GEO),

    // Behaviors
    define_builtin_function(bhv_cap_switch_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_tiny_star_particles_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_grindel_thwomp_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_koopa_shell_underwater_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_door_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_door_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_star_door_loop, PTYPE_FUNC_BHV),
    define_builtin_function_renamed(bhv_star_door_loop_update_render_state, bhv_star_door_loop_2, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_mr_i_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_mr_i_body_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_mr_i_particle_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_piranha_particle_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_giant_pole_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pole_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pole_base_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_thi_huge_island_top_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_thi_tiny_island_top_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_king_bobomb_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bobomb_anchor_mario_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_beta_chest_bottom_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_beta_chest_bottom_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_beta_chest_lid_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bubble_wave_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bubble_maybe_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bubble_player_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_air_bubble_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_air_bubble_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_particle_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_particle_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_waves_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_small_bubbles_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_fish_group_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_cannon_base_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_cannon_barrel_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_cannon_base_unused_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_chuckya_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_chuckya_anchor_mario_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_rotating_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wf_breakable_wall_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_kickable_board_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_tower_door_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wf_rotating_wooden_platform_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wf_rotating_wooden_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_fading_warp_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_warp_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_white_puff_exploding_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_spawned_star_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_spawned_star_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_coin_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_coin_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_coin_inside_boo_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_coin_formation_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_coin_formation_spawn_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_coin_formation_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_temp_coin_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_coin_sparkles_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_golden_coin_sparkles_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wall_tiny_star_particle_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pound_tiny_star_particle_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pound_tiny_star_particle_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_punch_tiny_triangle_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_punch_tiny_triangle_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_tumbling_bridge_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_tumbling_bridge_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_elevator_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_elevator_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_mist_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_mist_spawn_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_mist_2_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pound_white_puffs_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ground_sand_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ground_snow_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wind_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_unused_particle_spawn_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ukiki_cage_star_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ukiki_cage_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bitfs_sinking_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bitfs_sinking_cage_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ddd_moving_pole_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_platform_normals_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_tilting_inverted_pyramid_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_squishable_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_beta_moving_flames_spawn_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_beta_moving_flames_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_rr_rotating_bridge_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_flamethrower_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_flamethrower_flame_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bouncing_fireball_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bouncing_fireball_flame_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_shock_wave_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_flame_mario_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_black_smoke_mario_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_black_smoke_bowser_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_black_smoke_upward_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_beta_fish_splash_spawner_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_spindrift_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_tower_platform_group_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_tower_platform_group_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wf_sliding_tower_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wf_elevator_tower_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wf_solid_tower_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_snow_leaf_particle_spawn_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_tree_snow_or_leaf_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_piranha_plant_bubble_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_piranha_plant_waking_bubbles_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_purple_switch_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_hidden_object_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_breakable_box_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pushable_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_init_room, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_small_water_wave_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_yellow_coin_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_yellow_coin_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_squarish_path_moving_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_squarish_path_parent_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_squarish_path_parent_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_heave_ho_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_heave_ho_throw_mario_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ccm_touched_star_spawn_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_unused_poundable_platform, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_beta_trampoline_top_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_beta_trampoline_spring_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_jumping_box_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_boo_cage_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_boo_cage_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_key_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_key_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_grand_star_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_grand_star_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_beta_boo_key_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_alpha_boo_key_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bullet_bill_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bullet_bill_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_white_puff_smoke_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_tail_anchor_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_tail_anchor_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_body_anchor_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_body_anchor_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_flame_spawn_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_tilting_bowser_lava_platform_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_falling_bowser_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_blue_bowser_flame_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_blue_bowser_flame_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_flame_floating_landing_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_flame_floating_landing_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_blue_flames_group_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_flame_bouncing_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_flame_bouncing_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_flame_moving_forward_growing_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_flame_moving_forward_growing_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_flame_bowser_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_flame_bowser_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_flame_large_burning_out_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_blue_fish_movement_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_tank_fish_group_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_checkerboard_elevator_group_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_checkerboard_elevator_group_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_checkerboard_platform_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_checkerboard_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_key_unlock_door_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_key_course_exit_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_invisible_objects_under_bridge_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_invisible_objects_under_bridge_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_level_pillar_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_level_pillar_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ddd_warp_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_moat_grills_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_rotating_clock_arm_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ukiki_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ukiki_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_lll_sinking_rock_block_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_lll_moving_octagonal_mesh_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_lll_rotating_block_fire_bars_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_lll_rotating_hex_flame_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_lll_wood_piece_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_lll_floating_wood_bridge_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_volcano_flames_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_lll_rotating_hexagonal_ring_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_lll_sinking_rectangular_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_lll_sinking_square_platforms_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_koopa_shell_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_koopa_shell_flame_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_tox_box_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_piranha_plant_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_lll_bowser_puzzle_piece_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_lll_bowser_puzzle_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_tuxies_mother_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_small_penguin_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_fish_spawner_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_fish_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wdw_express_elevator_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bub_spawner_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bub_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_exclamation_box_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_exclamation_box_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_rotating_exclamation_box_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_sound_spawner_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowsers_sub_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_sushi_shark_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_sushi_shark_collision_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_jrb_sliding_box_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ship_part_3_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_sunken_ship_part_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_white_puff_1_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_white_puff_2_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_blue_coin_switch_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_hidden_blue_coin_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_openable_cage_door_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_openable_grill_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_level_diamond_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_init_changing_water_level_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_tweester_sand_particle_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_tweester_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_merry_go_round_boo_manager_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_animated_texture_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_boo_in_castle_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_boo_with_cage_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_boo_with_cage_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_boo_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_big_boo_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_courtyard_boo_triplet_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_boo_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_boo_boss_spawned_bridge_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bbh_tilting_trap_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_haunted_bookshelf_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_merry_go_round_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_play_music_track_when_touched_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_beta_bowser_anchor_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_static_checkered_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_castle_floor_trap_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_castle_floor_trap_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_floor_trap_in_castle_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_sparkle_spawn_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_scuttlebug_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_scuttlebug_spawn_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_whomp_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_splash_spawn_droplets, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_droplet_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_droplet_splash_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bubble_splash_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_idle_water_wave_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_shallow_water_splash_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wave_trail_shrink, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_strong_wind_particle_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_sl_snowman_wind_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_sl_walking_penguin_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_menu_button_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_menu_button_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_menu_button_manager_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_menu_button_manager_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_act_selector_star_type_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_act_selector_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_act_selector_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_moving_yellow_coin_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_moving_yellow_coin_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_moving_blue_coin_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_moving_blue_coin_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_blue_coin_sliding_jumping_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_blue_coin_sliding_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_blue_coin_jumping_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_seaweed_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_seaweed_bundle_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bobomb_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bobomb_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bobomb_fuse_smoke_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bobomb_buddy_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bobomb_buddy_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_cannon_closed_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_cannon_closed_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_whirlpool_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_whirlpool_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_jet_stream_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_homing_amp_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_homing_amp_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_circling_amp_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_circling_amp_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_butterfly_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_butterfly_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_hoot_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_hoot_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_beta_holdable_object_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_beta_holdable_object_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_object_bubble_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_object_bubble_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_object_water_wave_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_object_water_wave_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_explosion_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_explosion_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bobomb_bully_death_smoke_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bobomb_explosion_bubble_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bobomb_explosion_bubble_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_respawner_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_small_bully_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bully_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_big_bully_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_big_bully_with_minions_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_big_bully_with_minions_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_jet_stream_ring_spawner_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_jet_stream_water_ring_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_jet_stream_water_ring_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_manta_ray_water_ring_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_manta_ray_water_ring_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_bomb_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_bomb_explosion_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_bomb_smoke_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_celebration_star_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_celebration_star_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_celebration_star_sparkle_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_star_key_collection_puff_spawner_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_lll_drawbridge_spawner_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_lll_drawbridge_spawner_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_lll_drawbridge_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_small_bomp_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_small_bomp_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_large_bomp_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_large_bomp_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wf_sliding_platform_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wf_sliding_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_moneybag_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_moneybag_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_moneybag_hidden_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bob_pit_bowling_ball_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bob_pit_bowling_ball_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_free_bowling_ball_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_free_bowling_ball_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowling_ball_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowling_ball_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_generic_bowling_ball_spawner_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_generic_bowling_ball_spawner_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_thi_bowling_ball_spawner_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_rr_cruiser_wing_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_rr_cruiser_wing_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_spindel_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_spindel_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ssl_moving_pyramid_wall_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ssl_moving_pyramid_wall_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pyramid_elevator_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pyramid_elevator_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pyramid_elevator_trajectory_marker_ball_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pyramid_top_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pyramid_top_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pyramid_top_fragment_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pyramid_top_fragment_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pyramid_pillar_touch_detector_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_waterfall_sound_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_volcano_sound_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_castle_flag_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_birds_sound_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ambient_sounds_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_sand_sound_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_castle_cannon_grate_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_snowmans_bottom_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_snowmans_bottom_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_snowmans_head_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_snowmans_head_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_snowmans_body_checkpoint_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_big_boulder_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_big_boulder_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_big_boulder_generator_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wing_cap_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wing_vanish_cap_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_metal_cap_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_metal_cap_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_normal_cap_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_normal_cap_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_vanish_cap_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_collect_star_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_collect_star_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_star_spawn_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_star_spawn_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_hidden_red_coin_star_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_hidden_red_coin_star_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_red_coin_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_red_coin_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bowser_course_red_coin_star_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_hidden_star_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_hidden_star_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_hidden_star_trigger_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttm_rolling_log_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_rolling_log_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_lll_rolling_log_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_1up_common_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_1up_walking_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_1up_running_away_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_1up_sliding_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_1up_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_1up_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_1up_jump_on_approach_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_1up_hidden_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_1up_hidden_trigger_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_1up_hidden_in_pole_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_1up_hidden_in_pole_trigger_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_1up_hidden_in_pole_spawner_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_controllable_platform_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_controllable_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_controllable_platform_sub_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_breakable_box_small_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_breakable_box_small_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_sliding_snow_mound_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_snow_mound_spawn_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_floating_platform_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_arrow_lift_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_orange_number_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_orange_number_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_manta_ray_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_manta_ray_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_falling_pillar_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_falling_pillar_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_falling_pillar_hitbox_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_jrb_floating_box_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_decorative_pendulum_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_decorative_pendulum_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_treasure_chest_ship_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_treasure_chest_ship_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_treasure_chest_jrb_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_treasure_chest_jrb_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_treasure_chest_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_treasure_chest_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_treasure_chest_bottom_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_treasure_chest_bottom_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_treasure_chest_top_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_mips_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_mips_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_yoshi_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_koopa_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_koopa_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_koopa_race_endpoint_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pokey_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_pokey_body_part_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_swoop_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_fly_guy_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_goomba_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_goomba_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_goomba_triplet_spawner_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_chain_chomp_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_chain_chomp_chain_part_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wooden_post_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_chain_chomp_gate_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_chain_chomp_gate_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wiggler_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_wiggler_body_part_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_enemy_lakitu_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_camera_lakitu_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_camera_lakitu_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_cloud_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_cloud_part_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_spiny_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_monty_mole_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_monty_mole_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_monty_mole_hole_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_monty_mole_rock_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_platform_on_track_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_platform_on_track_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_track_ball_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_seesaw_platform_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_seesaw_platform_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ferris_wheel_axle_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ferris_wheel_platform_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_bomb_spawner_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_bomb_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_bomb_shadow_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_rotating_solid_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_rotating_solid_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_pendulum_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_pendulum_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_treadmill_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_treadmill_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_moving_bar_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_moving_bar_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_cog_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_cog_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_pit_block_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_pit_block_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_elevator_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_elevator_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_2d_rotator_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_2d_rotator_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ttc_spinner_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_mr_blizzard_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_mr_blizzard_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_mr_blizzard_snowball, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_sliding_plat_2_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_sliding_plat_2_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_rotating_octagonal_plat_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_rotating_octagonal_plat_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_animates_on_floor_switch_press_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_animates_on_floor_switch_press_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_activated_back_and_forth_platform_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_activated_back_and_forth_platform_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_recovery_heart_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_water_bomb_cannon_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bubble_cannon_barrel_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_unagi_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_unagi_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_unagi_subobject_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_dorrie_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_haunted_chair_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_haunted_chair_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_mad_piano_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_flying_bookend_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bookend_spawn_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_haunted_bookshelf_manager_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_book_switch_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_fire_piranha_plant_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_fire_piranha_plant_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_small_piranha_flame_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_fire_spitter_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_fly_guy_flame_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_snufit_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_snufit_balls_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_horizontal_grindel_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_horizontal_grindel_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_eyerok_boss_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_eyerok_boss_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_eyerok_hand_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_klepto_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_klepto_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bird_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_racing_penguin_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_racing_penguin_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_penguin_race_finish_line_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_penguin_race_shortcut_check_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_coffin_spawner_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_coffin_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_clam_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_skeeter_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_skeeter_wave_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_swing_platform_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_swing_platform_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_donut_platform_spawner_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_donut_platform_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ddd_pole_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ddd_pole_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_red_coin_star_marker_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_triplet_butterfly_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_bubba_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_intro_lakitu_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_intro_peach_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_end_birds_1_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_end_birds_2_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_intro_scene_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_dust_smoke_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_yoshi_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_volcano_trap_loop, PTYPE_FUNC_BHV),

    // mario_misc.h
    define_builtin_function(bhv_toad_message_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_toad_message_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_unlock_door_star_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_unlock_door_star_loop, PTYPE_FUNC_BHV),

    // Other
    define_builtin_function(load_object_collision_model, PTYPE_FUNC_BHV),
    define_builtin_function(obj_set_secondary_camera_focus, PTYPE_FUNC_BHV),

    // Menu related
    define_builtin_function(lvl_intro_update, PTYPE_FUNC_LVL),
    define_builtin_function(geo_intro_super_mario_64_logo, PTYPE_FUNC_GEO),
    define_builtin_function(geo_intro_tm_copyright, PTYPE_FUNC_GEO),
    define_builtin_function(geo_intro_regular_backdrop, PTYPE_FUNC_GEO),
    define_builtin_function(geo_draw_mario_head_goddard, PTYPE_FUNC_GEO),

    // Custom
    define_builtin_function(bhv_blue_coin_number_loop, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_blue_coin_switch_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_star_number_loop, PTYPE_FUNC_BHV),
    define_builtin_function(spawn_star_number, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_ferris_wheel_platform_init, PTYPE_FUNC_BHV),
    define_builtin_function(geo_mario_cap_display_list, PTYPE_FUNC_GEO),
    define_builtin_function(bhv_ambient_light_update, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_point_light_init, PTYPE_FUNC_BHV),
    define_builtin_function(bhv_point_light_loop, PTYPE_FUNC_BHV),
    define_builtin_function(geo_switch_character_type, PTYPE_FUNC_GEO),
};

static inline const char *DynOS_Builtin_Func_GetTypeName(u32 aPtrType) {
    switch (aPtrType) {
        case PTYPE_FUNC_GEO: return "geo layout";
        case PTYPE_FUNC_BHV: return "behavior";
        case PTYPE_FUNC_LVL: return "level script";
...
const void* DynOS_Builtin_Func_GetFromName(const char* aDataName, u32 aPtrType) {
    for (const auto &builtinFunc : sDynosBuiltinFuncs) {
        if (builtinFunc.type == aPtrType && DynOS_Builtin_Func_HasName(builtinFunc, aDataName)) {
...
const void* DynOS_Builtin_Func_GetFromIndex(s32 aIndex, u32 aPtrType) {
    ...
    if (sDynosBuiltinFuncs[aIndex].type != aPtrType) { return NULL; }
...
s32 DynOS_Builtin_Func_GetIndexFromData(const void* aData, u32 aPtrType) {
    ...
    for (s32 i = 0; i < count; ++i) {
        ...
        if (builtinFunc.type == aPtrType && builtinFunc.func == aData) {
            return i;
        }
    }
    return -1;
...
static String DynOS_Builtin_Func_CheckMisuse_Internal(s32 aIndex, const char* aDataName, const void* aData, u32 aPtrType) {
    s32 count = (s32) (sizeof(sDynosBuiltinFuncs) / sizeof(sDynosBuiltinFuncs[0]));
    for (s32 i = 0; i < count; ++i) {
        const auto &builtinFunc = sDynosBuiltinFuncs[i];
        if (aPtrType != builtinFunc.type && (
            aIndex == i || DynOS_Builtin_Func_HasName(builtinFunc, aDataName) || aData == builtinFunc.func)
        ) {
            return String(
                "Invalid use of %s function in %s: %s",
                builtinFunc.names[0],
                DynOS_Builtin_Func_GetTypeName(builtinFunc.type),
                DynOS_Builtin_Func_GetTypeName(aPtrType)
            );
        }
    }
    return "";
...
String DynOS_Builtin_Func_CheckMisuse(s32 aIndex, u32 aPtrType) {
    return DynOS_Builtin_Func_CheckMisuse_Internal(aIndex, NULL, NULL, aPtrType);
}

String DynOS_Builtin_Func_CheckMisuse(const char* aDataName, u32 aPtrType) {
    return DynOS_Builtin_Func_CheckMisuse_Internal(-1, aDataName, NULL, aPtrType);
}

String DynOS_Builtin_Func_CheckMisuse(const void* aData, u32 aPtrType) {
    return DynOS_Builtin_Func_CheckMisuse_Internal(-1, NULL, aData, aPtrType);
}
