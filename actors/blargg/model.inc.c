...
Gfx blargg_blargg_belly_rgba32_aligner[] = {gsSPEndDisplayList()};
u8 blargg_blargg_belly_rgba32[] = "actors/blargg/blargg_belly.rgba32";

Gfx blargg_blargg_body_rgba32_aligner[] = {gsSPEndDisplayList()};
u8 blargg_blargg_body_rgba32[] = "actors/blargg/blargg_body.rgba32";

Gfx blargg_blargg_eyes_rgba32_aligner[] = {gsSPEndDisplayList()};
u8 blargg_blargg_eyes_rgba32[] = "actors/blargg/blargg_eyes.rgba32";

Vtx blargg_000_offset_mesh_vtx_0[29] = {
...
Gfx blargg_000_offset_mesh_tri_0[] = {
	gsSPVertex(blargg_000_offset_mesh_vtx_0 + 0, 16, 0),
	...
	gsSPVertex(blargg_000_offset_mesh_vtx_0 + 16, 13, 0),
	gsSP1Triangle(0, 1, 2, 0),
	...
	gsSPEndDisplayList(),
};Vtx blargg_000_offset_mesh_vtx_1[68] = {
	{{{-56, -76, -42},0, {368, 496},{0xA4, 0xE5, 0xAD, 0xFF}}},
	{{{123, -97, -42},0, {368, 240},{0x53, 0xC9, 0xB0, 0xFF}}},
	{{{39, -263, -15},0, {624, 240},{0x30, 0xA0, 0xBB, 0xFF}}},
	{{{123, -97, 2},0, {368, 112},{0x71, 0xC6, 0x0, 0xFF}}},
	{{{62, -218, 2},0, {554, 170},{0x71, 0xC6, 0x0, 0xFF}}},
	{{{39, -263, 18},0, {624, 240},{0x30, 0xA0, 0x45, 0xFF}}},
	{{{123, -97, 45},0, {368, 240},{0x53, 0xC9, 0x50, 0xFF}}},
	{{{-56, -76, 45},0, {368, 496},{0xA4, 0xE5, 0x53, 0xFF}}},
	{{{-28, -255, 18},0, {624, 496},{0xB8, 0xB1, 0x44, 0xFF}}},
	{{{-28, -255, 2},0, {624, 624},{0xA8, 0xA5, 0x0, 0xFF}}},
	{{{-35, -206, 2},0, {554, 682},{0x83, 0xEC, 0x0, 0xFF}}},
	{{{-56, -76, 2},0, {368, 624},{0x83, 0xEC, 0x0, 0xFF}}},
	{{{-28, -255, -15},0, {624, 496},{0xB8, 0xB1, 0xBC, 0xFF}}},
	{{{6, -259, 2},0, {752, 368},{0xF1, 0x82, 0x0, 0xFF}}},
	{{{39, -263, 2},0, {752, 240},{0x3C, 0x90, 0x0, 0xFF}}},
	{{{-28, -255, 2},0, {752, 496},{0xA8, 0xA5, 0x0, 0xFF}}},
	{{{39, -263, 18},0, {624, 240},{0x30, 0xA0, 0x45, 0xFF}}},
	{{{39, -263, 2},0, {624, 112},{0x3C, 0x90, 0x0, 0xFF}}},
	{{{62, -218, 2},0, {554, 170},{0x71, 0xC6, 0x0, 0xFF}}},
	{{{39, -263, -15},0, {624, 240},{0x30, 0xA0, 0xBB, 0xFF}}},
	{{{-174, -182, -12},0, {624, 240},{0x1E, 0x99, 0xBC, 0xFF}}},
	{{{-90, -63, -36},0, {368, 240},{0x46, 0xBE, 0xAE, 0xFF}}},
	{{{-90, -63, 2},0, {368, 112},{0x67, 0xB6, 0x0, 0xFF}}},
	{{{-229, -163, -12},0, {624, 496},{0xAC, 0xBD, 0xBB, 0xFF}}},
	{{{-202, -173, 2},0, {752, 368},{0xD7, 0x88, 0x0, 0xFF}}},
	{{{-174, -182, 2},0, {752, 240},{0x27, 0x87, 0x0, 0xFF}}},
	{{{-174, -182, 16},0, {624, 240},{0x1E, 0x99, 0x44, 0xFF}}},
	{{{-229, -163, 16},0, {624, 496},{0xAC, 0xBD, 0x45, 0xFF}}},
	{{{-90, -63, 39},0, {368, 240},{0x46, 0xBE, 0x52, 0xFF}}},
	{{{-151, -150, 2},0, {554, 170},{0x67, 0xB6, 0x0, 0xFF}}},
	{{{-174, -182, 2},0, {624, 112},{0x27, 0x87, 0x0, 0xFF}}},
	{{{-236, -13, 39},0, {368, 496},{0x9E, 0xEF, 0x4F, 0xFF}}},
	{{{-229, -163, 2},0, {624, 624},{0x9B, 0xB3, 0x0, 0xFF}}},
	{{{-229, -163, 16},0, {624, 496},{0xAC, 0xBD, 0x45, 0xFF}}},
	{{{-236, -13, 39},0, {368, 496},{0x9E, 0xEF, 0x4F, 0xFF}}},
	{{{-231, -122, 2},0, {554, 682},{0x81, 0xFA, 0x0, 0xFF}}},
	{{{-236, -13, 2},0, {368, 624},{0x81, 0xFA, 0x0, 0xFF}}},
	{{{-236, -13, -36},0, {368, 496},{0x9E, 0xEF, 0xB1, 0xFF}}},
	{{{-229, -163, -12},0, {624, 496},{0xAC, 0xBD, 0xBB, 0xFF}}},
	{{{-90, -63, -36},0, {368, 240},{0x46, 0xBE, 0xAE, 0xFF}}},
	{{{-202, -173, 2},0, {752, 368},{0xD7, 0x88, 0x0, 0xFF}}},
	{{{-229, -163, 2},0, {752, 496},{0x9B, 0xB3, 0x0, 0xFF}}},
	{{{-345, -67, -12},0, {624, 240},{0xF9, 0x95, 0xBC, 0xFF}}},
	{{{-225, 17, -36},0, {368, 240},{0x2C, 0xAA, 0xAE, 0xFF}}},
	{{{-225, 17, 2},0, {368, 112},{0x48, 0x98, 0x0, 0xFF}}},
	{{{-390, -30, -12},0, {624, 496},{0x9B, 0xDD, 0xBC, 0xFF}}},
	{{{-367, -48, 2},0, {752, 368},{0xB1, 0x9D, 0x0, 0xFF}}},
	{{{-345, -67, 2},0, {752, 240},{0xFB, 0x81, 0x0, 0xFF}}},
	{{{-367, -48, 2},0, {752, 368},{0xB1, 0x9D, 0x0, 0xFF}}},
	{{{-345, -67, 2},0, {752, 240},{0xFB, 0x81, 0x0, 0xFF}}},
	{{{-345, -67, 16},0, {624, 240},{0xF9, 0x95, 0x44, 0xFF}}},
	{{{-390, -30, 16},0, {624, 496},{0x9B, 0xDD, 0x44, 0xFF}}},
	{{{-225, 17, 39},0, {368, 240},{0x2C, 0xAA, 0x52, 0xFF}}},
	{{{-225, 17, 2},0, {368, 112},{0x48, 0x98, 0x0, 0xFF}}},
	{{{-312, -44, 2},0, {554, 170},{0x48, 0x98, 0x0, 0xFF}}},
	{{{-345, -67, 2},0, {624, 112},{0xFB, 0x81, 0x0, 0xFF}}},
	{{{-345, -67, -12},0, {624, 240},{0xF9, 0x95, 0xBC, 0xFF}}},
	{{{-345, 114, 39},0, {368, 496},{0x9E, 0x12, 0x4E, 0xFF}}},
	{{{-390, -30, 2},0, {624, 624},{0x86, 0xDB, 0x0, 0xFF}}},
	{{{-378, 9, 2},0, {554, 682},{0x87, 0x26, 0x0, 0xFF}}},
	{{{-345, 114, 2},0, {368, 624},{0x87, 0x26, 0x0, 0xFF}}},
	{{{-345, 114, -36},0, {368, 496},{0x9E, 0x12, 0xB2, 0xFF}}},
	{{{-390, -30, -12},0, {624, 496},{0x9B, 0xDD, 0xBC, 0xFF}}},
	{{{-225, 17, -36},0, {368, 240},{0x2C, 0xAA, 0xAE, 0xFF}}},
	{{{-367, -48, 2},0, {752, 368},{0xB1, 0x9D, 0x0, 0xFF}}},
	{{{-390, -30, 2},0, {752, 496},{0x86, 0xDB, 0x0, 0xFF}}},
	{{{-390, -30, -12},0, {624, 496},{0x9B, 0xDD, 0xBC, 0xFF}}},
	{{{-390, -30, 16},0, {624, 496},{0x9B, 0xDD, 0x44, 0xFF}}},
};
...
Gfx blargg_000_offset_mesh_tri_1[] = {
	...
	gsSPVertex(blargg_000_offset_mesh_vtx_1 + 64, 4, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 3, 1, 0),
	gsSPEndDisplayList(),
};

Vtx blargg_000_offset_001_mesh_vtx_0[75] = {
...
Gfx blargg_000_offset_001_mesh_tri_0[] = {
	...
	gsSPVertex(blargg_000_offset_001_mesh_vtx_0 + 64, 11, 0),
	gsSP1Triangle(0, 1, 2, 0),
	...
	gsSP1Triangle(9, 7, 10, 0),
	gsSPEndDisplayList(),
};Vtx blargg_000_offset_001_mesh_vtx_1[15] = {
...
Gfx blargg_000_offset_001_mesh_tri_1[] = {
	gsSPVertex(blargg_000_offset_001_mesh_vtx_1 + 0, 15, 0),
	gsSP1Triangle(0, 1, 2, 0),
	...
	gsSPEndDisplayList(),
};Vtx blargg_000_offset_001_mesh_vtx_2[26] = {
...
Gfx blargg_000_offset_001_mesh_tri_2[] = {
	...
	gsSPVertex(blargg_000_offset_001_mesh_vtx_2 + 16, 10, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 3, 1, 0),
...
Vtx blargg_000_offset_003_mesh_vtx_0[38] = {
...
Gfx blargg_000_offset_003_mesh_tri_0[] = {
	gsSPVertex(blargg_000_offset_003_mesh_vtx_0 + 0, 14, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 3, 1, 0),
	gsSP1Triangle(4, 1, 3, 0),
	gsSP1Triangle(4, 5, 1, 0),
	...
	gsSPVertex(blargg_000_offset_003_mesh_vtx_0 + 14, 15, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	...
	gsSP1Triangle(12, 11, 13, 0),
	gsSP1Triangle(12, 13, 14, 0),
	gsSPVertex(blargg_000_offset_003_mesh_vtx_0 + 29, 9, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 3, 1, 0),
	...
	gsSPEndDisplayList(),
};Vtx blargg_000_offset_003_mesh_vtx_1[26] = {
...
Gfx blargg_000_offset_003_mesh_tri_1[] = {
	...
	gsSP1Triangle(12, 13, 14, 0),
	gsSP1Triangle(12, 15, 13, 0),
	gsSPVertex(blargg_000_offset_003_mesh_vtx_1 + 16, 10, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 3, 1, 0),
	gsSP1Triangle(0, 4, 3, 0),
	gsSP1Triangle(0, 5, 4, 0),
...
Gfx mat_blargg_blargg_belly[] = {
	...
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_32b, 32, blargg_blargg_belly_rgba32),
...
Gfx mat_blargg_blargg_mouth[] = {
	...
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_32b, 32, blargg_blargg_body_rgba32),
...
Gfx mat_blargg_blargg_eye[] = {
	...
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_32b, 32, blargg_blargg_eyes_rgba32),
	gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_32b, 8, 0, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 4, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0),
	gsDPLoadSync(),
	gsDPLoadTile(7, 0, 0, 124, 60),
	gsDPPipeSync(),
